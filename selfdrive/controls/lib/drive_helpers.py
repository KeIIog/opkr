...
MIN_SPEED = 1.0
LAT_MPC_N = 16   # 32     20240527 keiiog
LON_MPC_N = 32
CONTROL_N = 17
...
class VCruiseHelper:
  ...
  def update_v_cruise(self, CS, enabled, is_metric):
    ...
    if CS.cruiseState.available:
      ...
      self.v_cruise_kph = 50 #V_CRUISE_INITIAL
      self.v_cruise_cluster_kph = 50 #V_CRUISE_INITIAL
...
def get_lag_adjusted_curvature(CP, v_ego, psis, curvatures, curvature_rates, steerActuatorDelay):
  ...
  safe_desired_curvature = clip(desired_curvature,
                                current_curvature_desired - max_curvature_rate * 0.3 ,# DT_MDL , ##add curvature limit
                                current_curvature_desired + max_curvature_rate * 0.3)# DT_MDL). ##add curvature limit
